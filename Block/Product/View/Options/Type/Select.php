...
namespace Hungbd\CustomOptionImage\Block\Product\View\Options\Type;
    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == \Magento\Catalog\Api\Data\ProductCustomOptionInterface::OPTION_TYPE_DROP_DOWN
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                if ($_value->getDisplay_mode()=='image'){
                    $select->addOption(
                        $_value->getOptionTypeId(),
                        $_value->getTitle() . ' ' . strip_tags($priceStr) . '',
                        ['price'    => $this->pricingHelper->currencyByStore($_value->getPrice(true), $store, false),
                         'data-src' => 'image||' . $this->_storeManager->getStore()->getBaseUrl().'pub/media/'.$_value->getImageLink()
                        ]
                    );
                }
                else{
            ...
            if ($_option->getType() == \Magento\Catalog\Api\Data\ProductCustomOptionInterface::OPTION_TYPE_MULTIPLE) {
                ...
                $extraParams .= ' onchange="displaymutilimage(this,'.$_option->getId().');" ';
            }
            else{
                $extraParams .= ' onchange="displaysingleimage(this,'.$_option->getId().');" ';
            }
